<?php
    ...
    foreach ($sql as $value) 
    {
        ...
        "ciudad":"'.$value['ciudad'].'","regimen":"'.$value['regimen'].'","documento":"caja"';
    }
    $retorno.='}],"factura":[{';
    ...
    foreach ($sql as $value) 
    {
        $retorno.='{"producto":"'.$value['nombre_producto'].'","precio":"'.$value['precio_venta'].'","cantidad":"'.$value['cantidad'].'","generico":"'.$value['esgenerico'].'"},';
    }
