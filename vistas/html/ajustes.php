...
//echo($user_id." -id usuario<br>");
//ver en que grupo de usuario esta:
$sqlp = "SELECT * FROM users left join user_group on users.cargo_users = user_group.user_group_id Where users.id_users = '$user_id'";
$result = mysqli_query($conexion, $sqlp);
while ($rw = mysqli_fetch_array($result) ) {
	$id_grupo     = $rw['user_group_id'];
	$name 		  = $rw['name'];

	if($name === "Super Administrador" || $name === "GERENTE" || $name === "ADMINISTRADOR"){
		//echo("<br> if true");
		$permisos_ver = 1;
	}else{
		//echo("<br> if false");
									...
									<div class="form-group row">
										<div class="col-md-5">
											<div class="input-group">
												<input type="text" id="nombre_producto" class="form-control" placeholder="Nombre o Codigo del Producto" required  tabindex="2" autocomplete="off">
