    ...
    for($i = 0; $i < count($array_id); $i++)
    {
            ...
            if ($query_check_user == true) {
                ...
                $sql = "UPDATE productos SET nombre_producto='" . $nombreProducto . "',
                 ...
                 $query_paraStock = "INSERT INTO stock values(NULL,'$idProducto','1','$cantidadInventario' )";
                ...
                "(codigo_producto, nombre_producto, descripcion_producto, id_linea_producto, id_proveedor, inv_producto, iva_producto, estado_producto, costo_producto, utilidad_producto, valor1_producto, valor2_producto, valor3_producto, stock_producto, stock_min_producto, date_added, valor4_producto, esGenerico,date_vence) VALUES ".
                "('$codigo','$nombreProducto','$descripcion','$linea','$idprov','$inv','$ivaProd','$estado','$costoProd','$utilidad','$precio1Prod','$precio2Prod','$precio3Prod','$cantidadInventario','$cantMin','$date_added','$precio4Prod','$esGene1','$fecha')";
                $query_new_insert = mysqli_query($conexion, $sql);
                $sql = "SELECT * FROM productos WHERE codigo_producto ='" . $codigo . "';";
                $query_check_user_name = mysqli_query($conexion, $sql);
                $fila =  $query_check_user_name ->fetch_array();
