...
if (isset($_GET['numero_factura'])) {
	...
	//echo "select * from creditos_abonos left join clientes on creditos_abonos.id_cliente = clientes.id_cliente  where creditos_abonos.numero_factura = '$numero_factura' ";
	//"select * from creditos_abonos, clientes where creditos_abonos.numero_factura='$numero_factura' and creditos_abonos.id_cliente=clientes.id_cliente"
